 ...
 */
public class DownloadCategory extends AsyncTask<Object, Object, ClientSocket> implements SocketClientConstants {

    private Category cat = null;
    int result = DEFAULT;

    public DownloadCategory(Category cat){
        this.cat = cat;
    }
    ...
    protected ClientSocket doInBackground(Object... params) {
        ...
        try{
            clientSocket.sendCommand(OWNERDOWNLOAD);
